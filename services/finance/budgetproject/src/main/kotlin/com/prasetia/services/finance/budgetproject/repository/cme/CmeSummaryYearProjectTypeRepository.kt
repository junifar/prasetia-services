...
import com.prasetia.services.finance.budgetproject.model.cme.CmeSummaryYearProjectType
...
interface CmeSummaryYearProjectTypeRepository:CrudRepository<CmeSummaryYearProjectType, Long>{
    ...
    fun getCmeSummaryYearProjectType(@PathParam("tahun") tahun:Long):Iterable<CmeSummaryYearProjectType>
}
