...
@Repository
interface CmeProjectDetailCustomerRepository:CrudRepository<CmeProjectDetail, Long>{
    companion object {
        const val QUERY = """
                            SELECT
    ...
    fun getCmeProjectDetailCustomerRepository(@PathParam("tahun") tahun:Long):Iterable<CmeProjectDetail>
}
