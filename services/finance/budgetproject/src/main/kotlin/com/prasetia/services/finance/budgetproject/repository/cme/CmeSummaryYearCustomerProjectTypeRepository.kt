package com.prasetia.services.finance.budgetproject.repository.cme

import com.prasetia.services.finance.budgetproject.model.cme.CmeSummaryYearCustomerProjectType
...
@Repository
interface CmeSummaryYearCustomerProjectTypeRepository:CrudRepository<CmeSummaryYearCustomerProjectType, Long>{
    companion object {
        const val QUERY = """
                            SELECT
                            ...
                            "public".res_partner.id = :customer_id
                            GROUP BY
    ...
    fun getCmeSummaryYearProjectTypeCust(@PathParam("tahun") tahun:Long,
                                         @PathParam("customer_id") customer_id: Long):Iterable<CmeSummaryYearCustomerProjectType>

    @Async
    @Query(QUERY_NULL, nativeQuery = true)
    fun getCmeSummaryYearProjectTypeCust(@PathParam("tahun") tahun:Long):Iterable<CmeSummaryYearCustomerProjectType>
}
