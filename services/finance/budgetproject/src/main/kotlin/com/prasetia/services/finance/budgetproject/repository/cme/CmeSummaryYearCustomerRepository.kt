...
import com.prasetia.services.finance.budgetproject.model.cme.CmeSummaryYearCustomer
...
@Repository
interface CmeSummaryYearCustomerRepository:CrudRepository<CmeSummaryYearCustomer, Long>{
    companion object {
        const val QUERY = """
                            SELECT
    ...
    fun getCmeSummaryYearCustomer(@PathParam("tahun") tahun:Long):Iterable<CmeSummaryYearCustomer>
}
