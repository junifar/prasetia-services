...
import com.prasetia.services.finance.budgetmaintenance.model.preventive.PreventiveSummary
import org.springframework.data.jpa.repository.Query
import org.springframework.data.repository.CrudRepository
import org.springframework.stereotype.Repository

@Repository
interface  PreventiveSummaryRepository: CrudRepository<PreventiveSummary, Long>{
    companion object {
        const val QUERY = """
                            SELECT
                                ROW_NUMBER() OVER (ORDER BY "public".project_site.tahun) AS id,
    ...
    fun getAllPreventiveSummaryData():Iterable<PreventiveSummary>
}
