...
import com.prasetia.services.finance.budgetmaintenance.model.corrective.CorrectiveYear
...
interface CorrectiveYearRepository:CrudRepository<CorrectiveYear, Long>{
    ...
    @Async
    @Query(QUERY_YEAR_CUSTOMER, nativeQuery = true)
    fun getCorrectiveYearCustomer(@PathParam("tahun") tahun:Long, @PathParam("customer_id") customer_id:Long):Iterable<CorrectiveYear>
}
